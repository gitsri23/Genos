        ...
        child: Stack(
          ...
          children: [
                    ...
                    Positioned(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const PremiumGlass(
                            padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10), borderRadius: 20,
                            child: Row(children: [Icon(CupertinoIcons.tv, color: Colors.white), SizedBox(width: 20), Icon(CupertinoIcons.share, color: Colors.white)]),
                          ),
                        ],
                      ),
                    ),
            ...
            if (_isSwiping)
              Center(
                child: PremiumGlass(
                  padding: const EdgeInsets.all(20), borderRadius: 20,
                  child: Text(_printDur(_swipeSeekTo), style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                ),
              ),
          ],
        ),
...
class _GlassIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PremiumGlass(
      borderRadius: size / 2,
      child: SizedBox(width: size, height: size, child: Icon(icon, color: Colors.white, size: size * 0.5)),
    );
  }
}
